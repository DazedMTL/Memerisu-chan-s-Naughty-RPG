...
var Mano_InputConfig = (function () {
  ...
  function basicSymbols() {
    ...
    const pagedonw = createDefaultKeyMapperItem(
      "pagedown",
      param.mapperPagedown
    );
  ...
  class UnknowSymbol extends I_SymbolDefine {
    ...
    helpText() {
      return (
        setting.unknowGuidText.currentName() + "\n" + this.paramSettingGuide()
      );
    }
  }
  ...
  function extendsSymbols() {
    ...
    const listX = textList.map(function (text) {
      ...
      const eventObj = new EventCaller(
        Number(obj.eventId),
        Number(obj.inputType || 0)
      );
  ...
  class Scene_GamepadConfig_ALT extends Scene_InputConfigBase_MA {
    ...
    createSymbolListWindow() {
      ...
      slw.setHandler(
        CommandManager.alt().handle,
        this.gotoNormalMode.bind(this)
      );
      slw.setHandler(
        CommandManager.apply().handle,
        this.applyConfig.bind(this)
  ...
  Window_Options.prototype.addGamepadOptions_MA = function () {
    this.addCommand(
      setting.gamepadConfigCommandText.currentName(),
      MA_GAMEPAD_CONFIG
    );
  };
  Window_Options.prototype.addKeyboardConfig_MA = function () {
    this.addCommand(
      setting.keyConfigCommandText.currentName(),
      MA_KEYBOARD_CONFIG
    );
  };
  ...
  const Scene_Boot_onDatabaseLoaded =
