...
(function () {
  function decodeWorker() {
    ...
    var _stb_vorbis_decode_memory_float = (Module[
      ...
      return Module["asm"]["_stb_vorbis_decode_memory_float"].apply(
        null,
        arguments
      );
    });
    ...
    return initializeWorkerP.then(function (worker) {
      return new Promise(function (resolve, reject) {
        ...
        var onmessage = function (event) {
          ...
          resolve({ data: result.data, sampleRate: result.sampleRate });
        };
        worker.addEventListener("message", onmessage);
        worker.postMessage({ id: requestId, buf: buf }, [
