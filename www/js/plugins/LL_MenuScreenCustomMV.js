...
(function () {
  ...
  var currencyWindowPosition = String(
  ...
  var rightBottomBlockAlign = String(
  ...
  var leftBottomBlockAlign = String(
  ...
  Scene_MenuBase.prototype.createBackground = function () {
    ...
    if (originalBackgroundImage[0]) {
      ...
      this._backgroundSprite.bitmap = ImageManager.loadSystem(
        originalBackgroundImage[0].imageName
      );
  ...
  Window_MenuStatus.prototype.exDrawActorSimpleStatus = function (
    actor,
    x,
    y,
    width
  ...
  Window_MenuHelp.prototype.drawLeftBlock = function () {
    ...
    this.drawText(
      ...
      0,
      y,
      this.contents.measureTextWidth(leftBlockLabel),
      leftBlockAlign
    );
    this.resetTextColor();
    this.drawText(
      ...
      this.contents.measureTextWidth(leftBlockLabel),
      y,
      oneThirdWidth * 1 - this.contents.measureTextWidth(leftBlockLabel),
      leftBlockAlign
    );
  };
  ...
  Window_MenuHelp.prototype.drawRightBlock = function () {
    ...
    this.drawText(
      ...
      oneThirdWidth * 1,
      y,
      this.contents.measureTextWidth(rightBlockLabel),
      rightBlockAlign
    );
    this.resetTextColor();
    this.drawText(
      eval(rightBlockValue),
      this.contents.measureTextWidth(rightBlockLabel) + oneThirdWidth * 1,
      y,
      oneThirdWidth - this.contents.measureTextWidth(rightBlockLabel),
      rightBlockAlign
    );
  };
  ...
  Window_MenuHelp.prototype.drawCurrency = function () {
    ...
    if (currencyWindowPosition == "helpWindowRightBottom") {
      ...
      this.drawText(
        ...
        oneThirdWidth * 1.5,
        y,
        this.contents.measureTextWidth(rightBottomBlockLabel),
  ...
  Window_MenuHelp.prototype.drawMenuHelp = function () {
    ...
    if (leftBottomBlockLabel != "") {
      ...
      this.drawText(
        ...
        0,
        y,
        this.contents.measureTextWidth(leftBottomBlockLabel),
